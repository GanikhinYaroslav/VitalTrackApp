      ...
      <tr class="entry-row">
        ...
        <td>
          <div class="button-group">
            <button class="edit-button" data-index="${index}" title="Bearbeiten" href="#diary-form-container">
            ...
            <button class="delete-button" data-index="${index}" title="Löschen" href="#diary-form-container">
